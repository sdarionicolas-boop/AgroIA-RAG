...
_Generado: 2026-06-09 16:54 (hora local del runner)_
...
- Dataset: `Cordoba/` (164 peritajes reales 2018)
- Procesados: **164** lotes con NDVI CDSE real
...
| maiz × reproductivo_inicio | 9 | +0.072 | 0.8535 | -0.217 | +0.039 | [-0.845, +0.820] | +0.070 |
| maiz × vegetativo_avanzado | 18 | -0.216 | 0.3904 | -0.188 | -0.214 | [-0.594, +0.201] | -0.215 |
| maiz × vegetativo_temprano | 8 | -0.073 | 0.8635 | -0.249 | -0.130 | [-0.738, +0.278] | -0.083 |
| soja × desconocido | 1 | — | — | — | — | — | _n=1 < 5, no se calculan estadísticos_ |
| soja × llenado_grano | 20 | +0.343 | 0.1387 | +0.284 | +0.337 | [+0.028, +0.592] | +0.343 |
| soja × madurez | 3 | — | — | — | — | — | _n=3 < 5, no se calculan estadísticos_ |
| soja × reproductivo_inicio | 14 | +0.423 | 0.1320 | +0.354 | +0.418 | [+0.059, +0.722] | +0.423 |
| soja × vegetativo_avanzado | 2 | — | — | — | — | — | _n=2 < 5, no se calculan estadísticos_ |
| soja × vegetativo_temprano | 23 | +0.047 | 0.8316 | -0.142 | +0.023 | [-0.376, +0.447] | +0.046 |
| sorgo × vegetativo_temprano | 3 | — | — | — | — | — | _n=3 < 5, no se calculan estadísticos_ |
| trigo × llenado_grano | 12 | +0.246 | 0.4418 | +0.282 | +0.242 | [-0.419, +0.759] | +0.246 |
| trigo × madurez | 22 | -0.062 | 0.7849 | -0.051 | -0.049 | [-0.373, +0.310] | -0.061 |
| trigo × reproductivo_inicio | 19 | +0.540 | 0.0171 | +0.333 | +0.503 | [-0.231, +0.880] | +0.538 |

## Resultado global (todos los cultivos × estadíos)

- N = **164**
- Pearson R = **+0.1706** (p = 2.8939e-02)
- Spearman ρ = **+0.1092** (p = 1.6393e-01)
- Bootstrap CI95% = [+0.052, +0.279]
...
|----------:|:----------|:--------------------|:------------------|------------:|-----------:|------------:|------------:|:-----------------|:------------------|
|       471 | trigo     | reproductivo_inicio | 2018-10-18        |          21 |   0.585535 |    0.530302 |     9.4328  | 2018-09          | 2018-11           |
...
|      3110 | soja      | llenado_grano       | 2019-02-21        |          23 |   0.833997 |    0.607375 |    27.173   | 2019-01          | 2019-03           |
...
|      1303 | soja      | vegetativo_temprano | 2018-11-17        |          43 |   0.25089  |    0.313047 |   -24.7744  | 2018-10          | 2018-12           |
...
_(mostrando primeras 30 de 164 filas; ver JSON para set completo)_
